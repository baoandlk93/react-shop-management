...
function Register() {
    ...
    const validate = (data) => {
        ...
        if (!data.email) {
            ...
            errors.email = 'Invalid email address!  example@email.com';
        }
    ...
    const dialogFooter = <div className="text-center"><Button label="OK" className="p-button-text" autoFocus
        ...
        <div className="form-demo">
            <Dialog visible={showMessage} onHide={() => setShowMessage(false)} position="top" footer={dialogFooter}
                ...
                <div className="flex align-items-center flex-column pt-6 px-3">
                    ...
                    <div className="text-900 font-bold text-xl mt-5"> Successful!</div>
                    <p className="line-height-3 my-4">
                        Your account is registered under name <b>{formData.name}</b>. It'll be valid for 30 days without
            ...
            <div className="surface-card border-round shadow-2 p-4">
                <span className="text-900 text-2xl font-medium mb-4 block">Register</span>
